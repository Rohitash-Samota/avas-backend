...
@Table(name = "commerce_orders", indexes = {
        ...
        @Index(name = "idx_orders_tenant", columnList = "tenantId"),
        @Index(name = "idx_orders_project", columnList = "projectId")
})
public class OrderEntity extends AbstractLongIdEntity {
    ...
    public OrderEntity(UUID userId, String tenantId, String projectId, Type type, long total,
