...
import com.avas.platform.project.ProjectModels.DrawingCandidate;
...
class DrawingArtifactEntity {
    ...
    DrawingArtifactEntity(DrawingCandidate value, String payloadJson) {
        id = value.id(); projectId = value.projectId(); version = value.version(); strategy = value.strategy();
