...
class ProjectRecordEntity extends AbstractLongIdEntity {
    @Column(name = "public_id", nullable = false, unique = true, length = 80) private String publicId;
    ...
    ProjectRecordEntity(ProjectSummary project, String detailsJson, String tenantId, UUID ownerUserId) {
        publicId = project.id(); this.tenantId = tenantId; this.ownerUserId = ownerUserId;
    ...
    String publicId() { return publicId; } String projectCode() { return projectCode; } String name() { return name; }
