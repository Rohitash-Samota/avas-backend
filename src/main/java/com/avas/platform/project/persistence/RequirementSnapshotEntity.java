...
class RequirementSnapshotEntity extends AbstractLongIdEntity {
    @Column(name = "snapshot_id", nullable = false, unique = true, length = 120) private String snapshotId;
    ...
    RequirementSnapshotEntity(RequirementSummary value, String payloadJson) {
        snapshotId = value.snapshotId(); projectId = value.projectId(); version = value.version(); handlingLevel = value.handlingLevel();
